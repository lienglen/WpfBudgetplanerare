...
namespace WpfBudgetplanerare.Data
{
    ...
    {
        //Skapar DbSet för varje modell som ska representeras i databasen
        ...
        //Seedar in kategorier med statisk data
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Category>().HasData(
                ...
                new Category { CategoryId = 6, Name = "Bonus"},
                new Category { CategoryId = 7, Name = "Gift"}
            );

            //Seedar in två incomes
